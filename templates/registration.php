    ...
    <div class="container container--with-sidebar">
      ...
      <div class="content">
        <section class="content__side">
          ...
          <a class="button button--transparent content__side-button" href="?login=1">Войти</a>
        </section>
        ...
        <main class="content__main">
          ...
          <form class="form" action="index.php" method="post">
            <input hidden name="reg">
            <div class="form__row">
              <label class="form__label" for="email">E-mail <sup>*</sup></label>

              <input class="form__input <?php if($errors['email']):?>form__input--error<?php endif; ?>" type="email" name="email" id="email" value="<?=htmlspecialchars($_POST['email'])?>" placeholder="Введите e-mail">
            ...
            <div class="form__row">
              ...
              <input class="form__input <?php if($errors['name']):?>form__input--error<?php endif; ?>" type="text" name="name" id="name" value="<?=htmlspecialchars($_POST['name'])?>" placeholder="Введите имя">
